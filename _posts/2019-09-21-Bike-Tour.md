...
[For clarity and simplicity, I am assuming two things: first, that for every cracking probability (from $0$ to $1$), there is a pace, and that ties go to the lastest-finishing team.<sup>*<\/sup>]
