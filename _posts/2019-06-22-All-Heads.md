...
Now we break out Single. Since we were in A, there are three possible resultant state-types: H, B, and C.  If H, we are done.  If we don't win, we know we are in B or C.
